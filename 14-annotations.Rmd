...
To exit this screen, press 'esc' twice (if using RStudio) or right click twice (if using base R), and then press 'q' to quit the interactive mode. After quitting, `annotateRecording()` returns a data.table as below:
