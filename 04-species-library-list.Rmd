...
# rmarkdown::render(input = "04-species-library-list.Rmd", output_format = "md_document", output_file = "Chapter 4 - Species and Library.md")
...
>*Figure 4.2. Lists are  extremely versitile, and are used in many different examples throughout this book*.
