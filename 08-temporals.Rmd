...
RSQLite::dbExecute(conn = conx, statement =  "UPDATE deployment 
                                     ...
                                     WHERE locationID NOT IN ('location@1', 'location@2', 'location@3')")
```
...
```{r, out.width = 400, out.height = 300, echo = F}
...
RSQLite::dbGetQuery(conx, "SELECT locationID, type, date, time, dewpoint, pressure, moonPhase 
