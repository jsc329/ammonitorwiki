Chapter 13: The Soundscape Table
================
...
follows (borrowing liberally from the package helpfiles):
  ...
  - aci = acoustic complexity index, calculated with **soundecology**’s
    ...
    \[<span class="citeproc-not-found" data-reference-id="Pieretti">**???**</span>\].
...
```
    ...
    1 midEarth4_2016-03-04_06-00-00.wav 1500. 0.561            0.621          2.21     1.43  2.30 0.000869      0      0 2019-06-21
