...
```{r, echo=FALSE}
htmltools::img(src = knitr::image_uri('ammonitor-footer.png'), 
               alt = 'logo', 
...
```{r, eval = F, echo = F, out.width = '100%', echo = F, fig.align = 'center'}

knitr::include_graphics('ammonitor-footer.png', dpi = 500)
```
