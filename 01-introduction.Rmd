...
```{r, eval = T, out.width = '100%', echo = F, fig.align = 'left', out.extra='style="background-color:  #d3d3d3; padding:10px; display: inline-block;"'}
...
```{r, eval = T, out.width = '75%', echo = F, fig.align = 'left', out.extra='style="background-color:  #d3d3d3; padding:10px; display: inline-block;"'}
